...
computador3=random.choice(["gato","cachorro","galinha","pato","camelo","vaca","cavalo","avestruz","coelho","coruja","hamster"])
animal=(input("Agora adivinhe o animal que pensei \033[34mVOCÊ TEM UMA CHANCE\033[m:"))
if animal == computador3:
	print("\033[32mVOCÊ ACERTOU\033[m")
else:
	print("\033[31mVOCÊ ERROU\033[m")
	print("Pensei no animal",computador3)
cor=(input("Adivinhe a cor que pensei \033[34mVOCÊ TEM UMA CHANCE\033[m:"))
cores=random.choice(["amarelo","azul","roxo","preto","branco","rosa","verde","cinza","laranja","marrom","lilás"])
if cor == cores:
	print("\033[32mVOCÊ ACERTOU\033[m")
else:
   print("\033[31mVOCÊ ERROU\033[m")
   print("Pensei na cor",cores)
   print("\033[36m=\033[m"*20)
   print("\033[33mOBRIGADA POR JOGAR \033[m")
   print("\033[36m=\033[m"*20)
